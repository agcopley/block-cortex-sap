---
- dashboard: sales_performance_v2
  title: Sales Performance V2
  layout: newspaper
  ...
  - title: Sales Performance by Top 10 Products
    ...
    type: looker_column
    fields: [materials_md.material_text_maktx, sales_orders.sales_order_netvalue_global_currency_product_doc_type]
    sorts: [sales_orders.sales_order_netvalue_global_currency_product_doc_type desc
        0]
    limit: 500
    column_limit: 50
  ...
  - title: Sales Performance by Distribution Channel
    ...
    limit: 500
    dynamic_fields:
    - measure: sum_of_sales_order_netvalue_local_currency
      based_on: sales_orders.sales_order_netvalue_local_currency
      expression: ''
      label: Sum of Sales Order Netvalue Local Currency
      type: sum
      _kind_hint: measure
      _type_hint: number
    - measure: sum_of_sales_order_netvalue_local_currency_2
      based_on: sales_orders.sales_order_netvalue_local_currency
      expression: ''
      label: Sum of Sales Order Netvalue Local Currency
      type: sum
      _kind_hint: measure
      _type_hint: number
    - measure: sum_of_sales_order_net_price_local_currency
      based_on: sales_orders.sales_order_net_price_local_currency
      expression: ''
      label: Sum of Sales Order Net Price Local Currency
      type: sum
      _kind_hint: measure
      _type_hint: number
    - measure: sum_of_sales_order_netvalue_local_currency_3
      based_on: sales_orders.sales_order_netvalue_local_currency
      expression: ''
      label: Sum of Sales Order Netvalue Local Currency
      type: sum
      _kind_hint: measure
      _type_hint: number
    - measure: sum_of_sales_order_netvalue_local_currency_4
      based_on: sales_orders.sales_order_netvalue_local_currency
      expression: ''
      label: Sum of Sales Order Netvalue Local Currency
      type: sum
  ...
  - title: Total Customers
    ...
    column_limit: 50
    dynamic_fields:
    - measure: count_of_customer_number_kunnr
      based_on: customers_md.customer_number_kunnr
      expression: ''
      label: Count of Customer Number Kunnr
      type: count_distinct
      _kind_hint: measure
      _type_hint: number
      id: P6OqIto7kp
    - measure: count_of_customer_number_kunnr_2
      based_on: customers_md.customer_number_kunnr
      expression: ''
      label: Count of Customer Number Kunnr
      type: count_distinct
    ...
    width: 4
    height: 7
  - title: Sales of Top 10 Customers
    name: Sales of Top 10 Customers
    model: cortex_sap_operational
    explore: sales_orders
    type: looker_column
    fields: [customers_md.name1_name1, sales_orders.sales_order_net_price_global_currency_doc_type]
    sorts: [sales_orders.sales_order_net_price_global_currency_doc_type desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
    ...
    width: 10
    height: 7
  - title: Sales of Top 10 Products
    name: Sales of Top 10 Products
    model: cortex_sap_operational
    explore: sales_orders
    type: looker_column
    fields: [materials_md.material_text_maktx, sales_orders.sales_order_net_price_global_currency_doc_type]
    sorts: [sales_orders.sales_order_net_price_global_currency_doc_type desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
